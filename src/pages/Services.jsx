    ...
    <div className="services-page pt-40 pb-20">
      <div className="container">
        ...
        <div className="booking-cta mt-12 text-center">
          <p className="mb-8 text-muted">Don't see what you're looking for? <a href="tel:678-519-0769" className="text-primary hover:underline">Call us</a> for custom inquiries.</p>
          <a
            href="https://app.squareup.com/appointments/book/hx5cv4kciodolk/L8EMZEYG272GF/start"
            target="_blank"
            rel="noopener noreferrer"
